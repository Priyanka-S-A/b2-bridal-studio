  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <div
                ...
                style={{ border: '1px solid rgba(201,162,39,0.5)', boxShadow: '0 0 15px rgba(201,162,39,0.2)' }}
              >
                <span
              ...
              <div>
                <div className="font-cinzel text-xs tracking-[0.25em] uppercase" style={{ color: '#C9A227' }}>B2 Bridal</div>
                ...
                link.hasDropdown ? (
                  ...
                  >
                    <Link
                      ...
                      style={{ color: location.pathname.startsWith('/courses') ? '#C9A227' : 'rgba(248,245,240,0.7)', textDecoration: 'none' }}
                    ...
                    >
                      ...
                      <span className="absolute -bottom-1 left-0 h-px transition-all duration-300 group-hover:w-full" style={{ width: 0, background: 'linear-gradient(90deg, #C9A227, #e8d17a)' }} />
                    </Link>
                          ...
                          >
                            {COURSE_CATEGORIES.map((cat, i) => (
                              <Link
                                ...
                                style={{ borderBottom: i < COURSE_CATEGORIES.length - 1 ? '1px solid rgba(201,162,39,0.06)' : 'none' }}
                              ...
                              >
                                ...
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" stroke="rgba(201,162,39,0.4)" strokeWidth="1" className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                                  <path d="M3 2l4 3-4 3"/>
                                </svg>
                              </Link>
                            ))}
                            <div className="px-5 pt-3 pb-2" style={{ borderTop: '1px solid rgba(201,162,39,0.1)' }}>
                              <Link
                                to="/courses"
                              ...
                              >
                                View All Courses
                                <svg width="10" height="8" viewBox="0 0 10 8" fill="none" stroke="#C9A227" strokeWidth="1">
            ...
            <div className="flex lg:hidden items-center gap-2">
              ...
              >
                ...
                {itemCount > 0 && (
                  <span className="absolute top-0 right-0 w-4 h-4 flex items-center justify-center rounded-full text-[0.55rem] font-bold" style={{ background: '#C9A227', color: '#000' }}>
                    {itemCount > 9 ? '9+' : itemCount}
                  </span>
                )}
              </button>
              ...
              >
                <span className="block w-6 h-px transition-all duration-300 origin-center" style={{ background: '#C9A227', transform: menuOpen ? 'rotate(45deg) translateY(6px)' : 'none' }} />
                <span className="block h-px transition-all duration-300" style={{ background: '#C9A227', width: menuOpen ? 0 : '24px', opacity: menuOpen ? 0 : 1 }} />
                <span className="block w-6 h-px transition-all duration-300 origin-center" style={{ background: '#C9A227', transform: menuOpen ? 'rotate(-45deg) translateY(-6px)' : 'none' }} />
              </button>
            </div>
          </div>
      ...
      <motion.div
        ...
        style={{ background: 'rgba(0,0,0,0.97)', borderLeft: '1px solid rgba(201,162,39,0.15)' }}
      >
            ...
            <div key={link.to}>
              {link.hasDropdown ? (
                ...
                <Link
                  ...
                  style={{ color: 'rgba(248,245,240,0.7)', borderBottomColor: 'rgba(201,162,39,0.08)' }}
                >
                  {link.label}
                </Link>
              )}
...
const NavLink = ({ to, children, active }) => (
  <Link
    ...
    style={{ color: active ? '#C9A227' : 'rgba(248,245,240,0.7)', textDecoration: 'none' }}
    onMouseEnter={e => e.currentTarget.style.color = '#C9A227'}
    onMouseLeave={e => { if (!active) e.currentTarget.style.color = 'rgba(248,245,240,0.7)'; }}
  >
    {children}
    <span className="absolute -bottom-1 left-0 h-px transition-all duration-300 group-hover:w-full" style={{ width: active ? '100%' : 0, background: 'linear-gradient(90deg, #C9A227, #e8d17a)' }} />
  </Link>
);
