...
const BlogCard = ({ blog, delay }) => {
  ...
  <motion.article
    ...
    onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(201,162,39,0.1)'; }}
  >
    {/* Image */}
    ...
    <div className="flex flex-col flex-1 p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        <span className="font-cinzel text-[0.6rem] tracking-[0.2em] uppercase" style={{ color: 'rgba(201,162,39,0.5)' }}>
          {blog.date}
        </span>
      ...
      >
        Read Article
        <svg width="14" height="10" viewBox="0 0 14 10" fill="none" stroke="#C9A227" strokeWidth="1.2" strokeLinecap="round">
