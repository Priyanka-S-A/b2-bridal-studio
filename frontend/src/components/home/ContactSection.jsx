...
const ContactSection = () => {
  ...
  return (
    <section
      ...
      style={{ padding: '8rem 0', background: '#000' }}
    >
      ...
      <div className="max-w-[1300px] mx-auto px-6 lg:px-12" ref={ref}>
        ...
        >
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="font-cinzel text-[0.65rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>
              08 — Connect
            </span>
            <div className="gold-divider" style={{ width: '40px' }} />
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          >
            {sent ? (
              ...
              >
                ...
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div>
                  <label className="block font-cinzel text-[0.6rem] tracking-[0.3em] uppercase mb-2" style={{ color: 'rgba(201,162,39,0.6)' }}>
                    Full Name
                  </label>
                  <input
                    id="contact-name"
          ...
          >
            ...
            >
              {[
                {
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>,
                  label: 'Branch 1',
                ...
                {
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
                  label: 'Email',
                ...
                <div
                  ...
                  style={{ borderBottom: i < 3 ? '1px solid rgba(201,162,39,0.08)' : 'none' }}
                >
                  <span className="flex-shrink-0 mt-0.5">{item.icon}</span>
                  <div>
                    <div className="font-cinzel text-[0.6rem] tracking-[0.25em] uppercase mb-1" style={{ color: 'rgba(201,162,39,0.5)' }}>
                      {item.label}
                    </div>
                    <div className="font-cormorant text-sm leading-snug" style={{ color: 'rgba(248,245,240,0.7)' }}>
                      {item.value}
                    </div>
                  </div>
                </div>
            ...
            <div
              ...
              style={{ border: '1px solid rgba(201,162,39,0.12)', aspectRatio: '4/3' }}
            >
              <iframe
