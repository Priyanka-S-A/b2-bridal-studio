  ...
  return (
    <motion.div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow = '0 16px 50px rgba(201,162,39,0.1)';
      }}
      onMouseLeave={e => {
      ...
      <div className="p-7 flex flex-col flex-1">
            ...
            >
              ...
              >
                <div className="flex justify-between mb-2">
                  <span className="font-cinzel text-[0.6rem] tracking-[0.2em] uppercase" style={{ color: 'rgba(201,162,39,0.6)' }}>Duration</span>
                  <span className="font-cormorant text-sm" style={{ color: '#F8F5F0' }}>{course.duration}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-cinzel text-[0.6rem] tracking-[0.2em] uppercase" style={{ color: 'rgba(201,162,39,0.6)' }}>Level</span>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <Link
            ...
            style={{
              color: '#000',
              background: 'linear-gradient(135deg, #C9A227, #e8d17a)',
            }}
          >
            Enroll
          </Link>
