...
const GalleryShowcase = () => {
  ...
  return (
    <>
      <section id="gallery-showcase" className="relative overflow-hidden" style={{ padding: '8rem 0', background: '#000' }}>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12" ref={ref}>
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? 'visible' : 'hidden'} className="text-center mb-14">
            <motion.div variants={fadeUp} className="flex items-center justify-center gap-4 mb-4">
              ...
              <span className="font-cinzel text-[0.65rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Our Artistry</span>
              <div className="gold-divider" style={{ width: '40px' }} />
            </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {GALLERY_ITEMS.map((item, i) => (
              <motion.div
                ...
                style={{ aspectRatio: i === 0 || i === 5 ? '3/4' : '1/1', border: '1px solid rgba(201,162,39,0.08)' }}
              ...
              >
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.4) 50%, rgba(201,162,39,0.1) 100%)' }}
                >
                  <span className="font-cinzel text-[0.55rem] tracking-[0.3em] uppercase px-3 py-1 mb-2" style={{ background: 'rgba(201,162,39,0.9)', color: '#000' }}>
                    {item.category}
                  </span>
        ...
        {lightbox && (
          ...
          >
            ...
            >
              ...
              <button onClick={() => setLightbox(null)} className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.7)', color: '#C9A227', border: '1px solid rgba(201,162,39,0.3)' }}>
                ✕
              </button>
            </motion.div>
          </motion.div>
