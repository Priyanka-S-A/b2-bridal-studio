  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: '40%',
        height: '50%',
        background: 'radial-gradient(ellipse, rgba(255,215,120,0.08) 0%, transparent 70%)'
      }} />
      ...
      {sparkles.map(s => (
        <div key={s.id} style={{
          ...
          height: s.size,
          borderRadius: '50%',
          background: `rgba(201,162,39,${s.opacity})`,
          animation: `particle-float ${s.dur}s ease-in-out ${s.delay}s infinite`,
          boxShadow: `0 0 ${s.size * 4}px rgba(201,162,39,0.6)`
        }} />
      ))}
      ...
      <div style={{
        ...
        >
          ...
          <div>
            ...
            >
              <div style={{ height: 1, width: 40, background: 'linear-gradient(90deg, #C9A227, transparent)' }} />
              <span style={{
                fontFamily: "'Poppins'",
                fontSize: '0.6rem',
            ...
            {lines.map((line, i) => (
              <motion.h1
                ...
                style={{
                  ...
                  whiteSpace: 'nowrap',
                  overflow: 'hidden',
                  borderRight: '2px solid rgba(201,162,39,0.7)',
                  marginBottom: 6,
                  color: i === 1 ? 'transparent' : '#F5EFE6',
                  background: i === 1
                    ? 'linear-gradient(135deg, #C9A227, #f5e6a8, #b8901b)'
                    : 'none',
            ...
            >
              ...
              <div style={{
                ...
                background: `
                  ...
                  linear-gradient(180deg, rgba(201,162,39,0.05), rgba(201,162,39,0.15))
                `
              }} />
            </div>
      ...
      <style>{`
        @keyframes blinkCursor {
          0%, 50%, 100% { border-color: rgba(201,162,39,0.7); }
