      ...
      <div className="max-w-[1300px] mx-auto px-6 lg:px-12" ref={ref}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              <div className="font-cinzel text-[0.6rem] tracking-[0.3em] uppercase" style={{ color: '#C9A227' }}>
                Experience
              </div>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...pos,
                  borderTop: (pos.top === 0) ? '1px solid #C9A227' : 'none',
                  borderBottom: (pos.bottom === 0) ? '1px solid #C9A227' : 'none',
                  borderLeft: (pos.left === 0) ? '1px solid #C9A227' : 'none',
                  borderRight: (pos.right === 0) ? '1px solid #C9A227' : 'none',
                }}
              />
            ))}
          </motion.div>
            ...
            <motion.div variants={fadeUp}>
              <Link to="/about" className="btn-outline-gold inline-flex">
                ...
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="ml-2">
                  <path d="M1 7h12M7 1l6 6-6 6" stroke="#C9A227" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </Link>
            </motion.div>
          </motion.div>
