        ...
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(3)].map((_, i) => (
            <motion.div
              ...
              style={{
                top: `${30 + i * 20}%`,
                background: `linear-gradient(90deg, transparent, rgba(201,162,39,${0.1 + i * 0.05}), transparent)`,
              }}
        ...
        <div className="relative flex flex-col items-center gap-6">
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  background: 'linear-gradient(135deg, #e8d17a, #C9A227, #b8901b)',
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #e8d17a, #C9A227, #d4af37)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
              }}
          ...
          <motion.div
            ...
            style={{ width: '160px', background: 'rgba(201,162,39,0.1)' }}
          >
            <motion.div
              className="absolute inset-y-0 left-0"
              style={{
                background: 'linear-gradient(90deg, transparent, #C9A227, #e8d17a)',
              }}
              initial={{ width: '0%' }}
              animate={{ width: '100%' }}
