...
const StarRating = ({ count }) => (
  <div className="flex gap-1">
    {Array.from({ length: count }).map((_, i) => (
      <svg key={i} width="14" height="14" viewBox="0 0 14 14" fill="#C9A227">
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <div className="font-cinzel text-xs tracking-wider uppercase" style={{ color: 'rgba(201,162,39,0.5)' }}>
          ...
          <div className="max-w-3xl mx-auto">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div
                  ...
                  style={{ fontSize: '5rem', lineHeight: 0.8, color: 'rgba(201,162,39,0.2)' }}
                >
                  "
                </div>
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-cormorant text-xs italic mt-1" style={{ color: 'rgba(201,162,39,0.6)' }}>
                      {current.role}
                    </div>
                  </div>
                  ...
                  {current.isVideo && (
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="#C9A227">
                          <path d="M2 1l9 5-9 5V1z" />
                        </svg>
                      </div>
                      <span className="font-cinzel text-[0.6rem] tracking-[0.3em] uppercase" style={{ color: 'rgba(201,162,39,0.7)' }}>
                        Watch Review
                      </span>
                    </button>
                  )}
            ...
            <div className="flex items-center justify-center gap-6 mt-10">
              <button
                ...
                style={{ border: '1px solid rgba(201,162,39,0.25)', color: 'rgba(201,162,39,0.7)' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(201,162,39,0.1)'; e.currentTarget.style.borderColor = 'rgba(201,162,39,0.5)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = 'rgba(201,162,39,0.25)'; }}
              >
                ←
              </button>
                ...
                {testimonials.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      background: i === active ? '#C9A227' : 'rgba(201,162,39,0.25)',
                    }}
                  />
                ))}
              </div>
