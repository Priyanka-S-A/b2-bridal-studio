...
const features = [
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="#C9A227" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
...
const WhyChooseUs = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(201,162,39,0.2), transparent)' }} />
          ...
          {features.map((feature, i) => (
            ...
            >
              ...
              <div
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.boxShadow = '0 0 25px rgba(201,162,39,0.3)';
                  e.currentTarget.style.borderColor = 'rgba(201,162,39,0.5)';
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.boxShadow = '0 0 0 0 rgba(201,162,39,0)';
              ...
              <div className="w-0 group-hover:w-8 transition-all duration-500 h-px mb-4" style={{ background: 'linear-gradient(90deg, #C9A227, transparent)' }} />
