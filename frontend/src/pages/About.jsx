    ...
    <div style={{ background: '#000' }}>
      ...
      <section className="relative overflow-hidden" style={{ padding: '10rem 0 6rem' }} ref={heroRef}>
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={heroInView ? 'visible' : 'hidden'} className="max-w-[1200px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={slideLeft} className="relative">
            <div className="img-zoom-container rounded-sm" style={{ border: '1px solid rgba(201,162,39,0.15)' }}>
              <img
            ...
            {/* Floating stat */}
            <div className="absolute -bottom-6 -right-4 lg:-right-8 glass-dark px-6 py-4 text-center" style={{ border: '1px solid rgba(201,162,39,0.2)' }}>
              <div className="font-cinzel font-bold text-lg" style={{ color: '#C9A227' }}>15+</div>
          ...
          <motion.div variants={slideRight}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-cinzel text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>About Our Studio</span>
            </div>
            ...
            <p className="font-cormorant italic text-lg mb-4" style={{ color: 'rgba(201,162,39,0.7)' }}>
      ...
      <section className="relative" style={{ padding: '6rem 0' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} className="max-w-3xl mx-auto px-6 text-center">
          <span className="font-cinzel text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Our Vision</span>
      ...
      <section className="relative" style={{ padding: '6rem 0' }} ref={timelineRef}>
        ...
        <motion.div initial="hidden" animate={timelineInView ? 'visible' : 'hidden'} variants={staggerContainer} className="max-w-3xl mx-auto px-6 text-center mb-12">
          <motion.span variants={fadeUp} className="font-cinzel text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Our Journey</motion.span>
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          {TIMELINE.map((item, i) => (
            ...
            >
              {/* Dot */}
              <div className="absolute left-1/2 -translate-x-1/2 w-3 h-3 rounded-full z-10 hidden md:block" style={{ background: '#C9A227', boxShadow: '0 0 12px rgba(201,162,39,0.5)', top: '8px' }} />
              <div className="md:hidden absolute left-6 w-3 h-3 rounded-full z-10" style={{ background: '#C9A227', boxShadow: '0 0 12px rgba(201,162,39,0.5)', top: '8px' }} />

              {/* Content */}
              <div className={`flex-1 ${i % 2 === 0 ? 'md:text-right md:pr-12' : 'md:text-left md:pl-12'} pl-12 md:pl-0`}>
                <span className="font-cinzel text-xs tracking-[0.2em]" style={{ color: '#C9A227' }}>{item.year}</span>
      ...
      <section className="relative" style={{ padding: '6rem 0' }} ref={teamRef}>
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate={teamInView ? 'visible' : 'hidden'} className="text-center mb-12">
          <motion.span variants={fadeUp} className="font-cinzel text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Our Experts</motion.span>
          <motion.h2 variants={fadeUp} className="font-cinzel font-bold uppercase mt-3" style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.5rem)', color: '#F8F5F0', letterSpacing: '0.04em' }}>
            Meet the Team
          </motion.h2>
        </motion.div>
          ...
          {TEAM.map((member, i) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="font-cinzel text-[0.55rem] tracking-[0.2em] uppercase" style={{ color: 'rgba(201,162,39,0.6)' }}>{member.role}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="relative" style={{ padding: '6rem 0 8rem' }}>
        ...
        <div className="text-center mb-12">
          <span className="font-cinzel text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Locations</span>
        ...
        <div className="max-w-[1000px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            >
              <h3 className="font-cinzel text-sm tracking-[0.15em] uppercase mb-4" style={{ color: '#C9A227' }}>{branch.name}</h3>
              <div className="flex flex-col gap-3 mb-6">
                <div className="flex items-start gap-3">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5" className="mt-0.5 flex-shrink-0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                  <span className="font-cormorant text-sm leading-relaxed" style={{ color: 'rgba(248,245,240,0.6)' }}>{branch.address}</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5" className="flex-shrink-0"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.79 19.79 0 012.12 4.11 2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
