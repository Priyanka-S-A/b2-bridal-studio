        ...
        <div className="page-hero">
          <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-3xl mx-auto">
            <motion.div variants={fadeUp} className="flex items-center justify-center gap-4 mb-4">
              ...
              <span className="font-cinzel text-[0.65rem] tracking-[0.4em] uppercase" style={{ color: '#C9A227' }}>Academy</span>
              <div className="gold-divider" style={{ width: '40px' }} />
            </motion.div>
                ...
                <Link to={`/courses/${key}`} className="block card-luxury rounded-sm group" style={{ textDecoration: 'none' }}>
                  <div className="img-zoom-container relative" style={{ height: '220px' }}>
                    ...
                    <div className="absolute bottom-4 left-5 right-5">
                      <span className="font-cinzel text-[0.55rem] tracking-[0.3em] uppercase" style={{ color: '#C9A227' }}>
                  ...
                  <div className="p-5">
                    ...
                    <span className="font-cinzel text-[0.6rem] tracking-[0.2em] uppercase flex items-center gap-2 group-hover:gap-3 transition-all" style={{ color: '#C9A227' }}>
                      Explore Courses
                      <svg width="12" height="8" viewBox="0 0 12 8" fill="none" stroke="#C9A227" strokeWidth="1.2"><path d="M1 4h10M7 1l4 3-4 3" strokeLinecap="round" /></svg>
                    </span>
                  </div>
                </Link>
              </motion.div>
  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh' }} ref={ref}>
      ...
      <div className="page-hero relative">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="relative max-w-3xl mx-auto">
          ...
          <motion.div variants={fadeUp} className="mt-4">
            <Link to="/courses" className="font-cinzel text-[0.6rem] tracking-[0.15em] uppercase flex items-center justify-center gap-2" style={{ color: 'rgba(201,162,39,0.6)' }}>
      ...
      <div className="max-w-[1300px] mx-auto px-6 lg:px-12 pt-10 pb-4">
        <div className="glass-dark p-4 flex flex-wrap items-center justify-end gap-4" style={{ border: '1px solid rgba(201,162,39,0.1)' }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg>
          ...
          <select
            ...
            style={{ background: 'rgba(201,162,39,0.08)', border: '1px solid rgba(201,162,39,0.2)', color: '#F8F5F0' }}
          >
            ...
            >
              ...
              <div className="img-zoom-container relative" style={{ height: '180px' }}>
                ...
                <div className="absolute bottom-3 left-4 flex items-center gap-2">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#C9A227" strokeWidth="1.5"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg>
                  <span className="font-cinzel text-[0.6rem] tracking-[0.15em]" style={{ color: '#C9A227' }}>{course.duration}</span>
                </div>
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="mb-4 flex-1">
                  <h4 className="font-cinzel text-[0.55rem] tracking-[0.2em] uppercase mb-2 flex items-center gap-2" style={{ color: 'rgba(201,162,39,0.5)' }}>
                  ...
                  <ul className="flex flex-col gap-1.5">
                    {course.learn.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2 font-cormorant text-sm" style={{ color: 'rgba(248,245,240,0.6)' }}>
                        <svg width="8" height="8" viewBox="0 0 8 8" fill="#C9A227" className="mt-1.5 flex-shrink-0"><circle cx="4" cy="4" r="2" /></svg>
                        {item}
                      </li>
                    ))}
                  </ul>
                ...
                <button
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = '#C9A227'; e.currentTarget.style.color = '#000'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = 'rgba(201,162,39,0.1)'; e.currentTarget.style.color = '#C9A227'; }}
                >
