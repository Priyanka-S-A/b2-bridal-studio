...
export default function Billing() {
  ...
  const [successBill, setSuccessBill] = useState(null); // { _id }
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      {/* Page header */}
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 heading-luxury">Offline Billing</h2>
      ...
      {successBill && (
        <div className="mb-6 bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-green-600 mt-0.5">Bill #{successBill._id.slice(-8).toUpperCase()} — Revenue updated.</p>
            <div className="flex gap-3 mt-3 flex-wrap">
              <a
                href={`/bill/${successBill._id}`}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-black text-amber-400 text-xs font-semibold rounded-lg hover:bg-gray-800 transition-colors"
              >
                <FileText size={14} /> View Bill
              </a>
              <button
                onClick={() => generatePDF(successBill)}
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-amber-500 text-black text-xs font-semibold rounded-lg hover:bg-amber-400 transition-colors"
              >
                <Download size={14} /> Download PDF
              </button>
              <button
                onClick={() => handlePrint(successBill)}
              ...
              <button onClick={() => setSuccessBill(null)} className="ml-auto text-green-400 hover:text-green-600">
                <X size={18} />
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="mt-5 flex items-center gap-2 px-5 py-2.5 bg-black text-amber-400 rounded-lg text-sm font-semibold hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
                <Plus size={16} /> Add
              </button>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm flex flex-col">
          ...
          <div className="border-t border-gray-100 p-5">
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 mb-4">
              <span>Mode: <strong className="text-gray-600">{mode}</strong></span>
