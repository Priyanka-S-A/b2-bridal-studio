  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 heading-luxury">Manage Services</h2>
        {!isEditing && (
          <button 
            onClick={() => {
            ...
            className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-lg hover:bg-gold-500 hover:text-black transition-colors"
          >
      ...
      {isEditing ? (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-gray-900">{currentService._id ? 'Edit Service' : 'Add New Service'}</h3>
...
{currentService.category === "NEW" && (
  <input
    ...
    className="w-full mt-2 p-2.5 rounded-lg border border-gray-200"
    onChange={e => setCurrentService({...currentService, category: e.target.value})}
  />
)}
              </div>
              <div>
                ...
                <input 
                  ...
                  className="w-full p-2.5 rounded-lg border border-gray-200 outline-none focus:border-gold-500 focus:ring-1 focus:ring-gold-500"
            ...
            <div className="border-t border-gray-100 pt-6">
                    ...
                    <div key={idx} className="flex items-center gap-4 bg-gray-50 p-3 rounded-lg border border-gray-200">
                      <div className="flex-1">
                        <input 
                          ...
                          className="w-full p-2 border-b border-gray-300 bg-transparent outline-none focus:border-gold-500"
                        />
                      </div>
                      <div className="w-32">
                        <input 
              ...
              <button 
                ...
                className="flex items-center gap-2 text-sm text-gold-500 hover:text-black font-medium transition-colors"
              >
            ...
            <div className="flex justify-end gap-4 border-t border-gray-100 pt-6">
              ...
              <button 
                type="submit"
                className="flex items-center gap-2 bg-gold-500 text-black px-6 py-2 rounded-lg hover:bg-black hover:text-gold-500 transition-colors font-medium"
              >
